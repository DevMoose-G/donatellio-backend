...
def main():
    ...
    generate(
        flags.cfg, flags.ckpt, flags.output, flags.input, flags.elevation,
        flags.sample_num, flags.crop_size, flags.cfg_scale, flags.batch_view_num,
        flags.seed, flags.sampler, flags.sample_steps,
    )
