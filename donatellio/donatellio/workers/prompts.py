...
NAME_PROJECT_BASED_ON_PROMPT = "Concisely name the object based on the following prompt. Use no more than 9 words."
NAME_PROJECT_BASED_ON_IMAGE = "Concisely name the object based on the image given. Use no more than 9 words."