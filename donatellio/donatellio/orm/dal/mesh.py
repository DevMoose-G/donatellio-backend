...
class MeshDAL:
    ...
    async def create_mesh(self, id: str, project_id: str, image_id: str, url: str| None = None, seed: int | None = None, octree_resolution: str | None = None, num_inference_steps: int | None = None, face_count: int | None = None, texture: bool | None = None, guidance_scale: float | None = None):
        mesh = Mesh(id=id, project_id=project_id, image_id=image_id, url=url, seed=seed, octree_resolution=octree_resolution, num_inference_steps=num_inference_steps, face_count=face_count, texture=texture, guidance_scale=guidance_scale)
