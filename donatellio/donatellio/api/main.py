...
from donatellio.api.types import RequestCreateImage, RequestCreateUser, RequestEditImage, RequestGetElaboratingQuestions, RequestLoginUser
...
async def edit_image(
    ...
    msg_id = await stream.send_msg(RedisPayload(req.project_id, "edit_image", req.model_dump()))
