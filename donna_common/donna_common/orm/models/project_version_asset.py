...
class ProjectVersionAsset(Base):
    ...
    project_version_id: str = Column(String(128), ForeignKey("project_versions.id", ondelete="CASCADE"), nullable=False)
    asset_type: str = Column(asset_stage_enum, nullable=False)
    ...
    project_version = relationship("ProjectVersion", back_populates="assets", lazy="selectin")