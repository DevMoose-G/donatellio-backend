...
class RedisQueue:
    ...
    def queue_action(self, func_callback: str, expected_at: datetime, **kwargs) -> str:
        ...
        job = self.queue.enqueue(
            func_callback, **kwargs, result_ttl=86400, job_timeout=900
        )
    ...
    def queue_mesh_action(
        self, func_callback: str, expected_at: datetime, mesh_id: str, **kwargs
    ) -> str:
    ...
    def queue_image_action(
        self, func_callback: str, expected_at: datetime, image_id: str, **kwargs
    ) -> str:
        job_id = self.queue_action(
            func_callback=func_callback,
            expected_at=expected_at,
    ...
    def queue_texture_action(
        self, func_callback: str, expected_at: datetime, texture_id: str, **kwargs
    ) -> str:
        job_id = self.queue_action(
            func_callback=func_callback,
            expected_at=expected_at,
